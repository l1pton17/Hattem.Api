...
namespace Hattem.Api.Tests.Fluent
{
    partial class ThenTests
    {
        ...
        [Fact(DisplayName = "(Async, Sync) T2 Should call method if result is successful")]
        public async Task Then_Async_Sync_T2_Successful_CallMethod()
        {
            const int data1 = 2;
        ...
        [Fact(DisplayName = "(Async, Sync) T2 Shouldn't call method if result is error")]
        public async Task Then_Async_Sync_T2_HasError_DoesNotCallMethod()
        {
            const int data1 = 2;
        ...
        [Fact(DisplayName = "(Async, Sync) T3 Should call method if result is successful")]
        public async Task Then_Async_Sync_T3_Successful_CallMethod()
        {
            const int data1 = 2;
            const string data2 = "sta";
            const int data3 = 12;
        ...
        [Fact(DisplayName = "(Async, Sync) T3 Shouldn't call method if result is error")]
        public async Task Then_Async_Sync_T3_HasError_DoesNotCallMethod()
        {
            const int data1 = 2;
            const string data2 = "sta";
        ...
        [Fact(DisplayName = "(Async, Sync) T4 Should call method if result is successful")]
        public async Task Then_Async_Sync_T4_Successful_CallMethod()
        {
            const int data1 = 2;
            const string data2 = "sta";
            const int data3 = 12;
        ...
        [Fact(DisplayName = "(Async, Sync) T4 Shouldn't call method if result is error")]
        public async Task Then_Async_Sync_T4_HasError_DoesNotCallMethod()
        {
            const int data1 = 2;
            const string data2 = "sta";
        ...
        [Fact(DisplayName = "(Async, Sync) T5 Should call method if result is successful")]
        public async Task Then_Async_Sync_T5_Successful_CallMethod()
        {
            const int data1 = 2;
            const string data2 = "sta";
            const int data3 = 12;
        ...
        [Fact(DisplayName = "(Async, Sync) T5 Shouldn't call method if result is error")]
        public async Task Then_Async_Sync_T5_HasError_DoesNotCallMethod()
        {
            const int data1 = 2;
            const string data2 = "sta";
            const string data3 = "sta3";
