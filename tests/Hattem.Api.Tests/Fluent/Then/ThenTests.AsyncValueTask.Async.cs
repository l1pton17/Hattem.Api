...
namespace Hattem.Api.Tests.Fluent.Then
{
    ...
    {
        [Fact(DisplayName = "(Async ValueTask, Async) Should call method if result is successful")]
        public async Task Then_AsyncValueTask_Async_Successful_CallMethod()
        {
            const int data = 2;
        ...
        [Fact(DisplayName = "(Async ValueTask, Async) Shouldn't call method if result is error")]
        public async Task Then_AsyncValueTask_Async_HasError_DoesNotCallMethod()
        {
        ...
        [Fact(DisplayName = "(Async ValueTask, Async) T2 Should call method if result is successful")]
        public async Task Then_AsyncValueTask_Async_T2_Successful_CallMethod()
        {
            const int data1 = 2;
        ...
        [Fact(DisplayName = "(Async ValueTask, Async) T2 Shouldn't call method if result is error")]
        public async Task Then_AsyncValueTask_Async_T2_HasError_DoesNotCallMethod()
        {
            const int data1 = 2;
        ...
        [Fact(DisplayName = "(Async ValueTask, Async) T3 Should call method if result is successful")]
        public async Task Then_AsyncValueTask_Async_T3_Successful_CallMethod()
        {
            const int data1 = 2;
            const string data2 = "sta";
            const int data3 = 12;
        ...
        [Fact(DisplayName = "(Async ValueTask, Async) T3 Shouldn't call method if result is error")]
        public async Task Then_AsyncValueTask_Async_T3_HasError_DoesNotCallMethod()
        {
            const int data1 = 2;
            const string data2 = "sta";
        ...
        [Fact(DisplayName = "(Async ValueTask, Async) T4 Should call method if result is successful")]
        public async Task Then_AsyncValueTask_Async_T4_Successful_CallMethod()
        {
            const int data1 = 2;
            const string data2 = "sta";
            const int data3 = 12;
        ...
        [Fact(DisplayName = "(Async ValueTask, Async) T4 Shouldn't call method if result is error")]
        public async Task Then_AsyncValueTask_Async_T4_HasError_DoesNotCallMethod()
        {
            const int data1 = 2;
            const string data2 = "sta";
        ...
        [Fact(DisplayName = "(Async ValueTask, Async) T5 Should call method if result is successful")]
        public async Task Then_AsyncValueTask_Async_T5_Successful_CallMethod()
        {
            const int data1 = 2;
            const string data2 = "sta";
            const int data3 = 12;
        ...
        [Fact(DisplayName = "(Async ValueTask, Async) T5 Shouldn't call method if result is error")]
        public async Task Then_AsyncValueTask_Async_T5_HasError_DoesNotCallMethod()
        {
            const int data1 = 2;
            const string data2 = "sta";
            const string data3 = "sta3";
