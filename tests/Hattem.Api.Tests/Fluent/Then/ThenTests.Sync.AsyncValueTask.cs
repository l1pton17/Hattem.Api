...
namespace Hattem.Api.Tests.Fluent.Then
{
    ...
    {
        [Fact(DisplayName = "(Sync, Async ValueTask) Should call method if result is successful")]
        public async Task Then_Sync_AsyncValueTask_Successful_CallMethod()
        {
            const int data = 2;
        ...
        [Fact(DisplayName = "(Sync, Async ValueTask) Shouldn't call method if result is error")]
        public async Task Then_Sync_AsyncValueTask_HasError_DoesNotCallMethod()
        {
        ...
        [Fact(DisplayName = "(Sync, Async ValueTask) T2 Should call method if result is successful")]
        public async Task Then_Sync_AsyncValueTask_T2_Successful_CallMethod()
        {
            const int data1 = 2;
        ...
        [Fact(DisplayName = "(Sync, Async ValueTask) T2 Shouldn't call method if result is error")]
        public async Task Then_Sync_AsyncValueTask_T2_HasError_DoesNotCallMethod()
        {
            const int data1 = 2;
        ...
        [Fact(DisplayName = "(Sync, Async ValueTask) T3 Should call method if result is successful")]
        public async Task Then_Sync_AsyncValueTask_T3_Successful_CallMethod()
        {
            const int data1 = 2;
            const string data2 = "sta";
            const int data3 = 12;
        ...
        [Fact(DisplayName = "(Sync, Async ValueTask) T3 Shouldn't call method if result is error")]
        public async Task Then_Sync_AsyncValueTask_T3_HasError_DoesNotCallMethod()
        {
            const int data1 = 2;
            const string data2 = "sta";
        ...
        [Fact(DisplayName = "(Sync, Async ValueTask) T4 Should call method if result is successful")]
        public async Task Then_Sync_AsyncValueTask_T4_Successful_CallMethod()
        {
            const int data1 = 2;
            const string data2 = "sta";
            const int data3 = 12;
        ...
        [Fact(DisplayName = "(Sync, Async ValueTask) T4 Shouldn't call method if result is error")]
        public async Task Then_Sync_AsyncValueTask_T4_HasError_DoesNotCallMethod()
        {
            const int data1 = 2;
            const string data2 = "sta";
        ...
        [Fact(DisplayName = "(Sync, Async ValueTask) T5 Should call method if result is successful")]
        public async Task Then_Sync_AsyncValueTask_T5_Successful_CallMethod()
        {
            const int data1 = 2;
            const string data2 = "sta";
            const int data3 = 12;
        ...
        [Fact(DisplayName = "(Sync, Async ValueTask) T5 Shouldn't call method if result is error")]
        public async Task Then_Sync_AsyncValueTask_T5_HasError_DoesNotCallMethod()
        {
            const int data1 = 2;
            const string data2 = "sta";
            const string data3 = "sta3";
