...
namespace Hattem.Api.Tests.Fluent.IfError
{
    ...
    {
        [Fact(DisplayName = "(Async ValueTask, Async) CodeErrorPredicate")]
        public async Task AsyncValueTask_Async_CodeErrorPredicate()
        {
        ...
        [Fact(DisplayName = "(Async ValueTask, Async) ExactTypeErrorPredicate")]
        public async Task AsyncValueTask_Async_ExactTypeErrorPredicate()
        {
            const int ifErrorData = 3;
        ...
        [Fact(DisplayName = "(Async ValueTask, Async) TypeErrorPredicate")]
        public async Task AsyncValueTask_Async_TypeErrorPredicate()
        {
            const int ifErrorData = 3;
        ...
        [Theory(DisplayName = "(Async ValueTask, Async) Should call ifError if response has errors and error match")]
        [MemberData(nameof(ErrorPredicates))]
        public async Task AsyncValueTask_Async_HasErrors_ErrorMatch_CallIfError(
        ...
        [Theory(DisplayName = "(Async ValueTask, Async) Shouldn't call ifError if response has errors but error doesn't match")]
        [MemberData(nameof(ErrorPredicates))]
        public async Task AsyncValueTask_Async_HasErrors_ErrorDoesNotMatch_DoNotCallIfError(
            IErrorPredicate errorPredicate,
            Error _,
            Error invalidError
        )
        ...
        [Theory(DisplayName = "(Async ValueTask, Async) Shouldn't call ifError if response is ok")]
        [MemberData(nameof(ErrorPredicates))]
        public async Task AsyncValueTask_Async_IsOk_DoNotCallIfError(
            IErrorPredicate errorPredicate,
            Error _,
            Error __
        )
