...
namespace Hattem.Api.Tests.Fluent.Return
{
    partial class ReturnTests
    {
        ...
        [Fact(DisplayName = "(Async, Async value factory, T2) Should return value if response successful")]
        public async Task Async_AsyncValueFactory_T2_Successful_ReturnsValue()
        {
            const int data1 = 12;
            const int data2 = 23;
            const string expected = "test";
        ...
        [Fact(DisplayName = "(Async, Async value factory, T2) Should return error if response has error")]
        public async Task Async_AsyncValueFactory_T2_HasErrors_ReturnsValue()
        {
            const int data2 = 23;
            const string expected = "test";
        ...
        [Fact(DisplayName = "(Async, Async value factory, T3) Should return value if response successful")]
        public async Task Async_AsyncValueFactory_T3_Successful_ReturnsValue()
        {
            const int data1 = 12;
            const int data2 = 23;
            const int data3 = 34;
        ...
        [Fact(DisplayName = "(Async, Async value factory, T3) Should return error if response has error")]
        public async Task Async_AsyncValueFactory_T3_HasErrors_ReturnsValue()
        {
            const int data2 = 23;
            const int data3 = 34;
            const string expected = "test";
        ...
        [Fact(DisplayName = "(Async, Async value factory, T4) Should return value if response successful")]
        public async Task Async_AsyncValueFactory_T4_Successful_ReturnsValue()
        {
            const int data1 = 12;
            const int data2 = 23;
            const int data3 = 34;
        ...
        [Fact(DisplayName = "(Async, Async value factory, T4) Should return error if response has error")]
        public async Task Async_AsyncValueFactory_T4_HasErrors_ReturnsValue()
        {
            const int data2 = 23;
            const int data3 = 34;
            const int data4 = 45;
        ...
        [Fact(DisplayName = "(Async, Async value factory, T5) Should return value if response successful")]
        public async Task Async_AsyncValueFactory_T5_Successful_ReturnsValue()
        {
            const int data1 = 12;
            const int data2 = 23;
            const int data3 = 34;
        ...
        [Fact(DisplayName = "(Async, Async value factory, T5) Should return error if response has error")]
        public async Task Async_AsyncValueFactory_T5_HasErrors_ReturnsValue()
        {
            const int data2 = 23;
            const int data3 = 34;
            const int data4 = 45;
