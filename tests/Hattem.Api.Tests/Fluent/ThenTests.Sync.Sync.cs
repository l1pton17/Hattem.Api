...
{
    [CategoryTrait("Then")]
    public sealed partial class ThenTests
    {
        [Fact(DisplayName = "(Sync, Sync) Should call method if result is successful")]
        ...
        [Fact(DisplayName = "(Sync, Sync) Shouldn't call method if result is error")]
        ...
        [Fact(DisplayName = "(Sync, Sync) T2 Should call method if result is successful")]
        public void Then_Sync_Sync_T2_Successful_CallMethod()
        {
            const int data1 = 2;
        ...
        [Fact(DisplayName = "(Sync, Sync) T2 Shouldn't call method if result is error")]
        public void Then_Sync_Sync_T2_HasError_DoesNotCallMethod()
        {
            const int data1 = 2;
        ...
        [Fact(DisplayName = "(Sync, Sync) T3 Should call method if result is successful")]
        public void Then_Sync_Sync_T3_Successful_CallMethod()
        {
            const int data1 = 2;
            const string data2 = "sta";
            const int data3 = 12;
        ...
        [Fact(DisplayName = "(Sync, Sync) T3 Shouldn't call method if result is error")]
        public void Then_Sync_Sync_T3_HasError_DoesNotCallMethod()
        {
            const int data1 = 2;
            const string data2 = "sta";
        ...
        [Fact(DisplayName = "(Sync, Sync) T4 Should call method if result is successful")]
        public void Then_Sync_Sync_T4_Successful_CallMethod()
        {
            const int data1 = 2;
            const string data2 = "sta";
            const int data3 = 12;
        ...
        [Fact(DisplayName = "(Sync, Sync) T4 Shouldn't call method if result is error")]
        public void Then_Sync_Sync_T4_HasError_DoesNotCallMethod()
        {
            const int data1 = 2;
            const string data2 = "sta";
        ...
        [Fact(DisplayName = "(Sync, Sync) T5 Should call method if result is successful")]
        public void Then_Sync_Sync_T5_Successful_CallMethod()
        {
            const int data1 = 2;
            const string data2 = "sta";
            const int data3 = 12;
        ...
        [Fact(DisplayName = "(Sync, Sync) T5 Shouldn't call method if result is error")]
        public void Then_Sync_Sync_T5_HasError_DoesNotCallMethod()
        {
            const int data1 = 2;
            const string data2 = "sta";
            const string data3 = "sta3";
