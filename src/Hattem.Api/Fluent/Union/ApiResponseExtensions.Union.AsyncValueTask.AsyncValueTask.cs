...
namespace Hattem.Api.Fluent
{
    partial class ApiResponseExtensions
    {
        ...
        /// <returns></returns>
        public static async ValueTask<ApiResponse<(T1, T2)>> Union<T1, T2>(
        ...
        /// <param name="selector"></param>
        /// <returns></returns>
        public static async ValueTask<ApiResponse<(T1, T2, T3)>> Union<T1, T2, T3>(
        ...
        /// <param name="selector"></param>
        /// <returns></returns>
        public static async ValueTask<ApiResponse<(T1, T2, T3, T4)>> Union<T1, T2, T3, T4>(
        ...
        /// <param name="selector"></param>
        /// <returns></returns>
        public static async ValueTask<ApiResponse<(T1, T2, T3, T4, T5)>> Union<T1, T2, T3, T4, T5>(
